...
contract ("Test Case-3", accounts => {
    it('Test Case-3', async () => {

        console.log("--------------------------------------------------------------------")
        console.log("3 Pirates Participate In The Bidding Ring and 2 Normal People Participate in The Vickrey Auction");
        console.log("--------------------------------------------------------------------")
        ...
        let PirateBidder1 = accounts[2]; let PirateBidAmount1 = 3; let PirateNonce1 = 10;
        let PirateBidder2 = accounts[3]; let PirateBidAmount2 = 4; let PirateNonce2 = 5;
        let PirateBidder3 = accounts[4]; let PirateBidAmount3 = 1; let PirateNonce3 = 8;
        ...
        let PirateHashValue3 = soliditySha3(PirateBidAmount3, PirateNonce3);
        console.log("Address Of Pirate 1 --> ", PirateBidder1);
        console.log("Address Of Pirate 2 --> ", PirateBidder2);
        console.log("Address Of Pirate 3 --> ", PirateBidder3);
        console.log("--------------------------------------------------------------------")


        let Bidder1 = accounts[5]; let BidAmount1 = 5; let Nonce1 = 9;
        let Bidder2 = accounts[6]; let BidAmount2 = 8; let Nonce2 = 10;
        ...
        BarbossaInstance.PlaceBidInBarbossaBrethren(PirateHashValue3, {from : PirateBidder3});
        console.log("--------------------------------------------------------------------")
        ...
        BarbossaInstance.RevealBidInBarbossaBrethren(PirateBidAmount3, PirateNonce3, {from : PirateBidder3});
        console.log("--------------------------------------------------------------------")
