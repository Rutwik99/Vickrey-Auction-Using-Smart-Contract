...
contract ("Test Case-1", accounts => {
    it('Test Case-1', async () => {

        console.log("--------------------------------------------------------------------")
        console.log("2 Pirates Participate In The Bidding Ring and 3 Normal People Participate in The Vickrey Auction");
        console.log("--------------------------------------------------------------------")
        ...
        let Bidder1 = accounts[4]; let BidAmount1 = 1; let Nonce1 = 7;
        let Bidder2 = accounts[5]; let BidAmount2 = 2; let Nonce2 = 20;
        let Bidder3 = accounts[6]; let BidAmount3 = 7; let Nonce3 = 15;
